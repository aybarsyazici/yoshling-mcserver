      ...
      <div className="w-full max-w-sm space-y-6">
        <Card className="border-border/50 shadow-xl">
          <CardHeader className="text-center flex flex-col items-center pb-2">
            ...
            <CardTitle className="text-2xl font-bold">Yoshling</CardTitle>
          ...
          <CardContent className="pt-4">
            ...
            >
              <Button
                type="submit"
                className="w-full bg-[#5865F2] hover:bg-[#4752C4] text-white shadow-md hover:shadow-lg transition-all"
                size="lg"
              >
